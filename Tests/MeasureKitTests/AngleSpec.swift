...
class AngleSpec: QuickSpec {
    override func spec() {
        ...
        describe("AngleMUnit") {
            ...
            //
            ////                let munit = AngleMUnit.seconds.munit
            ...
            //                                max:5,
            //                                step:1,
            //                                possibleUnits: Set([AngleMUnit.seconds.munit]),
            //                                format)!
            //                let _ = Measure(result2,
            //                                possibleUnits: Set([AngleMUnit.hours.munit]),
            //                                format)!
            //                let _ = Measure(result3,
            //                                possibleUnits: Set([AngleMUnit.minutes.munit]),
            //                                format)!
            //            }
        }
    }
