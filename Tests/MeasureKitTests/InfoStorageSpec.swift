...
class InfoStorageSpec: QuickSpec {
    override func spec() {
        
        describe("InfoStorageMUnit") {
            ...
            //
            ////                let munit = InfoStorageMUnit.seconds.munit
            ...
            //                                max:5,
            //                                step:1,
            //                                possibleUnits: Set([InfoStorageMUnit.seconds.munit]),
            //                                format)!
            //                let _ = Measure(result2,
            //                                possibleUnits: Set([InfoStorageMUnit.hours.munit]),
            //                                format)!
            //                let _ = Measure(result3,
            //                                possibleUnits: Set([InfoStorageMUnit.minutes.munit]),
            //                                format)!
            //            }
        }
    }
