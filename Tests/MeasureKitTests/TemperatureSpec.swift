...
class TemperatureSpec: QuickSpec {
    override func spec() {
        ...
        describe("TemperatureMUnit") {
            ...
            //
            ////                let munit = TemperatureMUnit.seconds.munit
            ...
            //                                max:5,
            //                                step:1,
            //                                possibleUnits: Set([TemperatureMUnit.seconds.munit]),
            //                                format)!
            //                let _ = Measure(result2,
            //                                possibleUnits: Set([TemperatureMUnit.hours.munit]),
            //                                format)!
            //                let _ = Measure(result3,
            //                                possibleUnits: Set([TemperatureMUnit.minutes.munit]),
            //                                format)!
            //            }
        }
    }
