...
class LengthSpec: QuickSpec {
    override func spec() {
        
        describe("LengthMUnit") {
            ...
            //
            ////                let munit = LengthMUnit.seconds.munit
            ...
            //                                max:5,
            //                                step:1,
            //                                possibleUnits: Set([LengthMUnit.seconds.munit]),
            //                                format)!
            //                let _ = Measure(result2,
            //                                possibleUnits: Set([LengthMUnit.hours.munit]),
            //                                format)!
            //                let _ = Measure(result3,
            //                                possibleUnits: Set([LengthMUnit.minutes.munit]),
            //                                format)!
            //            }
        }
    }
